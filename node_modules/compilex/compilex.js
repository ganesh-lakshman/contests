...
// exports.flush = function(fn, dirPath = './temp/') {
//   fs.readdir(dirPath, function(err, files) {
//     if (err) {
//       // If there was an error reading the directory, call the callback function with the error
//       fn(err);
//       return;
//     }
//     // If the directory is empty, call the callback function with no error
//     if (files.length === 0) {
//       fn();
//       return;
//     }

//     // Iterate through all the files/folders in the directory
...
//       if (stat.isDirectory()) {
//         exports.flush(function(err) {
//           // If there was an error deleting the directory, call the callback function with the error
//           if (err) {
//             fn(err);
//             return;
//           }
//           // Delete the directory once all its contents have been deleted
//           fs.rmdir(filePath, function(err) {
//             if (err) {
//               fn(err);
//               return;
//             }
//             // If it's the last file/folder, call the callback function with no error
//             if (i === files.length - 1) {
//               fn();
//             }
//           });
